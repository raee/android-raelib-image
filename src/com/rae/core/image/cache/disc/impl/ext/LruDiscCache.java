 ...
 * the License.
 *******************************************************************************/
package com.rae.core.image.cache.disc.impl.ext;
 ...
 * {@link com.rae.core.image.cache.disc.impl.ext.DiskLruCache DiskLruCache} to
 * {@link com.rae.core.image.cache.disc.DiskCache DiskCache}
 * 
...
public class LruDiscCache implements DiskCache
{
	 ...
	 *            {@linkplain com.rae.core.image.cache.disc.naming.FileNameGenerator
	 ...
	 */
	public LruDiscCache(File cacheDir, FileNameGenerator fileNameGenerator,
			long cacheMaxSize, int cacheMaxFileCount)
	{
		if (cacheDir == null) { throw new IllegalArgumentException("cacheDir"
				+ ERROR_ARG_NULL); }
		if (cacheMaxSize < 0) { throw new IllegalArgumentException(
				"cacheMaxSize" + ERROR_ARG_NEGATIVE); }
		if (cacheMaxFileCount < 0) { throw new IllegalArgumentException(
				"cacheMaxFileCount" + ERROR_ARG_NEGATIVE); }
		if (fileNameGenerator == null) { throw new IllegalArgumentException(
				"fileNameGenerator" + ERROR_ARG_NULL); }
