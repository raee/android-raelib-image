...
import com.rae.core.image.loader.assist.LoadedFrom;
import com.rae.core.image.loader.assist.ViewScaleType;
import com.rae.core.image.loader.imageaware.ImageAware;
import com.rae.core.image.loader.imageaware.ImageViewAware;
import com.rae.core.image.loader.imageaware.NonViewAware;
...
import com.rae.core.image.utils.ImageSizeUtils;
...
public class ImageLoader
{
	 ...
	 * @param imageAware
	 *            {@linkplain com.rae.core.image.loader.imageaware.ImageAware
	 ...
	 *            Image aware view} which should display image
	 * @param options
	 *            {@linkplain com.rae.core.image.loader.DisplayImageOptions
	 ...
	 *            {@linkplain com.rae.core.image.loader.listener.ImageLoadingProgressListener
	...
	{
		checkConfiguration();
		if (imageAware == null) { throw new IllegalArgumentException(
		...
		if (bmp != null && !bmp.isRecycled())
		{
			...
			if (options.shouldPostProcess())
			{
				...
				ProcessAndDisplayImageTask displayTask = new ProcessAndDisplayImageTask(
						engine, bmp, imageLoadingInfo, defineHandler(options)); // 显示图片线程
				if (options.isSyncLoading()) // 图片是否正在下载
				{
					displayTask.run();
				}
				else
	 ...
	 * {@link com.rae.core.image.loader.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * 
	 * @param imageAware
	 *            {@link com.rae.core.image.loader.imageaware.ImageAware
	 ...
	 * {@linkplain com.rae.core.image.loader.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
