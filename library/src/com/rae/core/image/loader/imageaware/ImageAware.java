 ...
 *******************************************************************************/
package com.rae.core.image.loader.imageaware;
 ...
 * through {@link com.rae.core.image.loader.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.rae.core.image.loader.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.rae.core.image.loader.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.rae.core.image.loader.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.rae.core.image.loader.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.rae.core.image.loader.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.rae.core.image.loader.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.rae.core.image.loader.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.rae.core.image.loader.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.rae.core.image.loader.display.BitmapDisplayer BitmapDisplayer}
	 * .< br />
